...
--
-- Host: 127.0.0.1
-- Generation Time: 29 Apr 2018 pada 20.17
...
(2, 'tes', '$2y$05$1unnoTXPQ0f6rmVM5IcemOywTOTDiSq/x3tYzQSINK5igm5MHWNva', '');
...
--
ALTER TABLE `t_instruksi_kerja`
  MODIFY `id_instruksi_kerja` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `t_kelompok_jenis_uji`
  MODIFY `id_kelompok_jenis_uji` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
